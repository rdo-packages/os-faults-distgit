...
# Make executables
for file in %{buildroot}%{python3_sitelib}/%{pypi_name}/ansible/modules/{freeze,iptables,kill}.py; do
   chmod a+x $file
done
%endif
...
# Make executables
for file in %{buildroot}%{python2_sitelib}/%{pypi_name}/ansible/modules/{freeze,iptables,kill}.py; do
   chmod a+x $file
done
...
# REMOVEME: error caused by commit http://git.openstack.org/cgit/openstack/os-faults/commit/?id=82cb4323980882a7e6b860fd6a3cbb2b3df5f9d1
